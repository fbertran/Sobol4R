...
```{r, cache=TRUE, eval=LOCAL}
autoplot.sobol(ex1_results, ncol = 1)
```
...
autoplot.sobol(ex2_results$x_det)
autoplot.sobol(ex2_results$x_noise)
autoplot.sobol(ex2_results$x_qoi)
```
...
```{r, fig.keep='all', cache=TRUE, eval=LOCAL}
autoplot.sobol(ex3_results$x_single)
autoplot.sobol(ex3_results$x_qoi)
```
...
```{r, fig.keep='all', cache=TRUE, eval=LOCAL}
autoplot.sobol(ex4_results$x_single)
autoplot.sobol(ex4_results$x_qoi)
```
...
```{r, fig.keep='all', cache=TRUE, eval=LOCAL}
autoplot.sobol(ex5_results$xp_single)
autoplot.sobol(ex5_results$xp_qoi)
```
